...
(function () {
    ...
    function init() {
        ...
        // --------------------------------------------------------
        // Show section — uses direct style, not CSS class
        // --------------------------------------------------------
        ...
        function validateSection1() {
            ...
            if (!dob || !dob.value) {
                ...
                if (age < 18 || age > 65) errors.push('You must be between 18 and 65 years of age.');
            }

            var gender = document.getElementById('gender');
            if (!gender || !gender.value) errors.push('Please select your gender.');

            var marital = document.getElementById('marital_status');
            if (!marital || !marital.value) errors.push('Please select your marital status.');

            var education = document.getElementById('education_level');
            if (!education || !education.value) errors.push('Please select your education level.');
        ...
        function validateSection2() {
            ...
            if (!employment || !employment.value) errors.push('Please select your employment status.');
        ...
        function validateSection3() {
            ...
            if (!address || !address.value.trim()) errors.push('Home address is required.');
        ...
        function validateSection4() {
            ...
            if (!loanAmount || loanAmount.value === '') {
                ...
                if (amt < 10000 || amt > 2000000) errors.push('Loan amount must be between \u20a610,000 and \u20a62,000,000.');
            }
            ...
            if (!tenure || tenure.value === '') {
                ...
                if (t < 1 || t > 36) errors.push('Repayment period must be between 1 and 36 months.');
            }
        ...
        // --------------------------------------------------------
        // Attach button handler — works for both click and touchend
        // --------------------------------------------------------
        ...
        // Back buttons
        // --------------------------------------------------------
        attachHandler('back-2', function () { clearErrors(); showSection(1); });
        attachHandler('back-3', function () { clearErrors(); showSection(2); });
        attachHandler('back-4', function () { clearErrors(); showSection(3); });
        ...
        if (defaultsNo) {
            defaultsNo.addEventListener('change', function () {
                ...
                if (existingInput)   { existingInput.required = false; existingInput.value = ''; }
            });
        }
